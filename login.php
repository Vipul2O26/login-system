        ...
        if( ( !$emailFlag ) && ( !$passwordFlag) ) {
            ...
            try {
                ...
                if($user && password_verify($_POST['password'],$user['password'])) {
                    ...
                    $alert = "<div class='alert alert-danger' role='alert'>email or password is incorrect</div>";
                }
                    ...
                    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="email" id="email" class="form-control border-info <?php echo $emailError ? 'border-danger' : '' ?>" value="<?php echo $email; ?>" placeholder="enter email">
                                <small class="text-danger"> <?php echo $emailError  ?></small>
                                <small class="form-text text-danger invalid-feedback">your email is not valid</small>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <small class="form-text text-danger invalid-feedback">password should be more than 8 character</small>                                
                            </div>
                            ...
                            <div class="col-12">
                                <div class="text-center">
                                    <input type="submit" id="submitloginform" value="Login" class="btn btn-info text-light w-100 py-3">
                                </div>
                            </div>
 ...
 <script>
    ...
    function validatePassword(){
        ...
        if ( password.length < 8 ) {
            passwordInput.addClass("is-invalid border-danger").removeClass("border-info");
            return false;
        } else  {
            passwordInput.removeClass("is-invalid border-danger border-info border-success").addClass("border-success");
            return true;
        }
